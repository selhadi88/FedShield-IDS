...
print(f"Global test set: {X_test.shape[0]} windows, classes present: {sorted(set(y_test))}")
...
if ckpt_files:
    ...
    print(f"Resuming from checkpoint: {last} (round {start_round} already complete)")
...
global_model.save(f'{DATA_DIR}/baseline_model_fullscale.h5')
